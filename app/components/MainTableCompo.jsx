...
import { weekDays ,lectureTimeDay } from './data';
import clsx from 'clsx';

const MainTable = ({onlineT2})=>{
    const [iFocus,setIFocus]=useState(true);
    const days = weekDays;
            ...
            <div className='w-full px-1 '>
                ...
                <div className='w-full flex justify-between border-2 border-black  h-8'>
                    ...
                    <div className='w-1/12 text-center'>
                        <button className='text-xs font-bold bg-black rounded-md shadow-sm py-1 px-2 text-white' onClick={()=>setIFocus(pre=>!pre)}>تركيز</button>
                    </div>
                ...
                <div className='w-full flex justify-between border-2 border-black '>
                    ...
                    <div className={clsx(`w-11/12  border-2 border-black`,iFocus &&'text-gray-300')}>
                        ...
                        <div className='grid grid-cols-6 grid-rows-5 text-[7px] font-bold'>
