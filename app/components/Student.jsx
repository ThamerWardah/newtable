    ...
    return(
        <div className="relative h-full w-full ">
            ...
            {hamburger &&   <div className="absolute bg-gradient-to-b from-black/70 to-gray-100 z-50 top-0 left-0 flex w-full h-full">
                 <div className="w-4/5 h-full">
                     ...
                     <div className="w-full h-32  bg-blue-400 flex flex-col py-2 px-4 justify-between  text-white font-bold">
                      ...
                      <div className="mb-4">
                           ...
                           <h1 dir="ltr" className="font-bold text-md text-start ">{user?.name}</h1>
                        ...
                        <Link className=' active:bg-red-500 w-fit' href='/people'><ImTable className="inline-block text-3xl  pr-2"/>الجدول</Link>
                ...
                <button onClick={()=>signOut()} className='active:bg-red-500 text-start w-fit ' href='/people'>
